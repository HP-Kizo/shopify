          ...
          <div className="col-lg-8 col-md-10 col-sm-12">
            <div className="container-fluid">
              <div className="row catogery g-2">
                <NavLink to="/shop/iphone" className="col-6">
                  <img src={Product_1} className="w-100" />
                </NavLink>
                <NavLink to="/shop/mac" className="col-6">
                  <img src={Product_2} className="w-100" />
                </NavLink>
              </div>
              <div className="row catogery g-1   mt-4">
                <NavLink to="/shop/ipad" className="col-4">
                  <img className="w-100" src={Product_3} />
                </NavLink>
                <NavLink to="/shop/watch" className="col-4">
                  <img className="w-100" src={Product_4} />
                </NavLink>
                <NavLink to="/shop/airpod" className="col-4">
